...
*Generated automatically in 272.9ms for Gemini 3.8 Flash High.*
...
- **Total Dart Lines**: 16178
- **Indexed Symbols**: 1730
...
| [`lib/core/models/mod_borrow.dart`](lib/core/models/mod_borrow.dart) | 71 | Borrow | Core Models |
| [`lib/core/models/mod_exchange.dart`](lib/core/models/mod_exchange.dart) | 57 | Exchange | Core Models |
| [`lib/core/models/mod_expense.dart`](lib/core/models/mod_expense.dart) | 64 | Expense | Core Models |
...
| File | Lines | Key Classes / Functions | Primary Purpose |
| :--- | :---: | :--- | :--- |
| [`lib/core/services/f_auth.dart`](lib/core/services/f_auth.dart) | 76 | AuthService | Core Services |
...
| [`lib/core/services/f_firestore.dart`](lib/core/services/f_firestore.dart) | 59 | FirestoreServiceBase, FirestoreService | Core Services |
| [`lib/core/services/f_firestore_emails.dart`](lib/core/services/f_firestore_emails.dart) | 71 | FirestoreEmailsMixin | Core Services |
| [`lib/core/services/f_firestore_expenses.dart`](lib/core/services/f_firestore_expenses.dart) | 38 | FirestoreExpensesMixin | Core Services |
| [`lib/core/services/f_firestore_purge.dart`](lib/core/services/f_firestore_purge.dart) | 96 | FirestorePurgeMixin | Core Services |
| [`lib/core/services/f_firestore_transfers.dart`](lib/core/services/f_firestore_transfers.dart) | 71 | FirestoreTransfersMixin | Core Services |
| [`lib/core/services/f_firestore_users_balances.dart`](lib/core/services/f_firestore_users_balances.dart) | 37 | FirestoreUsersBalancesMixin | Core Services |
...
| [`lib/core/utils/m_formatters.dart`](lib/core/utils/m_formatters.dart) | 58 | Formatters | Core Utilities & Math |
| [`lib/core/utils/m_validators.dart`](lib/core/utils/m_validators.dart) | 85 | Validators | Core Utilities & Math |

## Feature: Home Tab
| File | Lines | Key Classes / Functions | Primary Purpose |
| :--- | :---: | :--- | :--- |
| [`lib/features/home/components/c_activity_tile.dart`](lib/features/home/components/c_activity_tile.dart) | 1 | - | Feature: Home Tab |
| [`lib/features/home/components/c_add_action_sheet.dart`](lib/features/home/components/c_add_action_sheet.dart) | 1 | - | Feature: Home Tab |
| [`lib/features/home/components/c_add_exchange_dialog.dart`](lib/features/home/components/c_add_exchange_dialog.dart) | 1 | - | Feature: Home Tab |
| [`lib/features/home/components/c_add_expense_dialog.dart`](lib/features/home/components/c_add_expense_dialog.dart) | 1 | - | Feature: Home Tab |
| [`lib/features/home/components/c_borrow_dialog.dart`](lib/features/home/components/c_borrow_dialog.dart) | 1 | - | Feature: Home Tab |
| [`lib/features/home/components/c_delete_activity_dialog.dart`](lib/features/home/components/c_delete_activity_dialog.dart) | 1 | - | Feature: Home Tab |
| [`lib/features/home/components/c_home_action_handler.dart`](lib/features/home/components/c_home_action_handler.dart) | 75 | HomeActionHandler | Feature: Home Tab |
| [`lib/features/home/components/c_home_activities_list.dart`](lib/features/home/components/c_home_activities_list.dart) | 81 | HomeActivitiesList | Feature: Home Tab |
...
| [`lib/features/home/components/c_home_tab_actions.dart`](lib/features/home/components/c_home_tab_actions.dart) | 83 | HomeTabActions | Feature: Home Tab |
...
| [`lib/features/home/feed/vm_home_feed_mutations.dart`](lib/features/home/feed/vm_home_feed_mutations.dart) | 45 | HomeFeedMutations, HomeFeedMutationsMixin | Feature: Home Tab |
...
| [`lib/features/home/feed/vm_home_feed_state.dart`](lib/features/home/feed/vm_home_feed_state.dart) | 66 | HomeFeedState | Feature: Home Tab |
| [`lib/features/home/models/mod_activity_item.dart`](lib/features/home/models/mod_activity_item.dart) | 1 | - | Feature: Home Tab |
| [`lib/features/home/s_home.dart`](lib/features/home/s_home.dart) | 96 | HomeScreen, _HomeScreenState | Feature: Home Tab |
| [`lib/features/home/s_home_tab.dart`](lib/features/home/s_home_tab.dart) | 89 | HomeTabScreen | Feature: Home Tab |
| [`lib/features/home/vm_home.dart`](lib/features/home/vm_home.dart) | 24 | HomeViewModel | Feature: Home Tab |
| [`lib/features/home/vm_home_feed.dart`](lib/features/home/vm_home_feed.dart) | 113 | HomeFeedViewModel | Feature: Home Tab |

## Feature: My Tracker Tab
| File | Lines | Key Classes / Functions | Primary Purpose |
| :--- | :---: | :--- | :--- |
| [`lib/features/my_tracker/components/c_my_tracker_actions.dart`](lib/features/my_tracker/components/c_my_tracker_actions.dart) | 48 | MyTrackerActions | Feature: My Tracker Tab |
| [`lib/features/my_tracker/components/c_my_tracker_list.dart`](lib/features/my_tracker/components/c_my_tracker_list.dart) | 74 | MyTrackerExpenseList | Feature: My Tracker Tab |
...
| [`lib/features/my_tracker/tracker/vm_my_tracker_filter.dart`](lib/features/my_tracker/tracker/vm_my_tracker_filter.dart) | 6 | MyTrackerFilter | Feature: My Tracker Tab |
| [`lib/features/my_tracker/tracker/vm_my_tracker_getters.dart`](lib/features/my_tracker/tracker/vm_my_tracker_getters.dart) | 82 | MyTrackerGettersMixin | Feature: My Tracker Tab |
...
| [`lib/features/settings/components/c_friend_balance_item.dart`](lib/features/settings/components/c_friend_balance_item.dart) | 71 | FriendBalanceItem | Feature: Settings Tab |
...
| [`lib/features/settings/components/c_initial_balances_card.dart`](lib/features/settings/components/c_initial_balances_card.dart) | 92 | InitialBalancesCard | Feature: Settings Tab |
| [`lib/features/settings/components/c_initial_balances_resolver.dart`](lib/features/settings/components/c_initial_balances_resolver.dart) | 92 | InitialBalancesData | Feature: Settings Tab |
...
| File | Lines | Key Classes / Functions | Primary Purpose |
| :--- | :---: | :--- | :--- |
| [`lib/features/auth/components/c_access_denied_screen.dart`](lib/features/auth/components/c_access_denied_screen.dart) | 68 | AccessDeniedScreen | Feature: Auth |
| [`lib/features/auth/components/c_auth_whitelist_gate.dart`](lib/features/auth/components/c_auth_whitelist_gate.dart) | 102 | AuthWhitelistGate, _AuthWhitelistGateState | Feature: Auth |
...
| [`lib/core/components/activity_tiles/c_activity_expense_tile.dart`](lib/core/components/activity_tiles/c_activity_expense_tile.dart) | 105 | - | Core UI Components |
...
| [`lib/core/components/c_add_expense_dialog.dart`](lib/core/components/c_add_expense_dialog.dart) | 68 | - | Core UI Components |
...
| [`lib/core/components/c_borrow_dialog.dart`](lib/core/components/c_borrow_dialog.dart) | 69 | - | Core UI Components |
...
| [`lib/core/components/exchange_dialog/c_exchange_submit_handler.dart`](lib/core/components/exchange_dialog/c_exchange_submit_handler.dart) | 63 | ExchangeSubmitHandler | Core UI Components |
| [`lib/core/components/expense_dialog/c_expense_dialog_body.dart`](lib/core/components/expense_dialog/c_expense_dialog_body.dart) | 107 | ExpenseDialogBody | Core UI Components |
...
| [`lib/core/components/expense_dialog/c_expense_dialog_fields.dart`](lib/core/components/expense_dialog/c_expense_dialog_fields.dart) | 105 | ExpenseDialogFields | Core UI Components |
...
| [`lib/core/components/expense_dialog/c_expense_dialog_submit.dart`](lib/core/components/expense_dialog/c_expense_dialog_submit.dart) | 67 | ExpenseSubmitHandler | Core UI Components |
...
| [`lib/core/components/expense_dialog/c_expense_dialog_view.dart`](lib/core/components/expense_dialog/c_expense_dialog_view.dart) | 92 | ExpenseDialogView, _ExpenseDialogViewState | Core UI Components |
...
| File | Lines | Key Classes / Functions | Primary Purpose |
| :--- | :---: | :--- | :--- |
| [`lib/core/animations/a_animated_amount.dart`](lib/core/animations/a_animated_amount.dart) | 42 | AnimatedAmount | Core Animations |
...
| [`lib/core/animations/a_expandable.dart`](lib/core/animations/a_expandable.dart) | 32 | AnimatedExpandable | Core Animations |
...
| File | Lines | Key Classes / Functions | Primary Purpose |
| :--- | :---: | :--- | :--- |
| [`lib/core/theme/t_app_theme.dart`](lib/core/theme/t_app_theme.dart) | 91 | AppTheme | Theme |
...
| [`lib/main.dart`](lib/main.dart) | 63 | MyApp, main | Root / Config |
...
| [`test/utils_test.dart`](test/utils_test.dart) | 341 | main, group, test | Tests |
| [`test/widget_test.dart`](test/widget_test.dart) | 10 | main, testWidgets | Tests |
