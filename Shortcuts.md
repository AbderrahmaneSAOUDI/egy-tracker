...
| `a_*.dart` | **Animations** | Animation builders, transitions, and motion helpers | `a_fade_slide_transition.dart`, `a_press_scale.dart`, `a_staggered_item.dart`, `a_dialog_transition.dart`, `a_animated_amount.dart`, `a_shimmer.dart` |
